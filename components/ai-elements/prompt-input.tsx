...
export const PromptInputActionAddScreenshot = ({
  ...
  const handleSelect = useCallback(
    async (event: Event) => {
      // biome-ignore lint/suspicious/noExplicitAny: cross-type passthrough for base-ui v1.5 event compat
      (onSelect as unknown as ((e: Event) => void) | undefined)?.(event);
...
export const PromptInputSubmit = ({
  ...
  const handleClick = useCallback(
    (e: React.MouseEvent<HTMLButtonElement>) => {
      ...
      // base-ui v1.5 event type is a superset of React.MouseEvent
      (onClick as unknown as ((e: React.MouseEvent<HTMLButtonElement>) => void) | undefined)?.(e);
    },
...
export const PromptInputHoverCard = ({
  ...
  <HoverCard
    {...({ closeDelay, openDelay } as Record<string, unknown>)}
    {...props}
  />
);
